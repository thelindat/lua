...
template<typename T, qualifier Q>
GLM_GEOM_QUALIFIER Sphere<3, T, Q> enclose(const Sphere<3, T, Q> &sphere, const AABB<3, T, Q> &aabb) {
  return encloseObject<3, T, Q, AABB<3, T, Q>, 8>(sphere, aabb);  // @TODO: Replace specialization w/ 2^L
}

template<typename T, qualifier Q>
GLM_GEOM_QUALIFIER Sphere<2, T, Q> enclose(const Sphere<2, T, Q> &sphere, const AABB<2, T, Q> &aabb) {
...
/// </returns>
template<typename T, qualifier Q>
GLM_GEOM_QUALIFIER_OUTINLINE bool fitSphereThroughPoints(const vec<3, T, Q> &ab, const vec<3, T, Q> &ac, const vec<3, T, Q> &ad, T &s, T &t, T &u) {
  const T bb = dot(ab, ab);
  const T bc = dot(ab, ac);
...
/// </summary>
template<typename T, qualifier Q>
GLM_GEOM_QUALIFIER_OUTINLINE Sphere<3, T, Q> optimalEnclosingSphere(const vec<3, T, Q> &a, const vec<3, T, Q> &b, const T eps = epsilon<T>()) {
...
/// </summary>
template<typename T, qualifier Q>
GLM_GEOM_QUALIFIER_OUTINLINE Sphere<3, T, Q> optimalEnclosingSphere(const vec<3, T, Q> &a, const vec<3, T, Q> &b, const vec<3, T, Q> &c, const T eps = epsilon<T>()) {
  Sphere<3, T, Q> sphere;
  const vec<3, T, Q> ab = b - a;
  const vec<3, T, Q> ac = c - a;
...
/// </summary>
template<typename T, qualifier Q>
GLM_GEOM_QUALIFIER_OUTINLINE Sphere<3, T, Q> optimalEnclosingSphere(const vec<3, T, Q> &a, const vec<3, T, Q> &b, const vec<3, T, Q> &c, const vec<3, T, Q> &d, const T eps = epsilon<T>()) {
  T s(0), t(0), u(0);
  Sphere<3, T, Q> sphere;
...
/// unnecessary).
template<typename T, qualifier Q>
GLM_GEOM_QUALIFIER_OUTINLINE Sphere<3, T, Q> optimalEnclosingSphere(const vec<3, T, Q> &a, const vec<3, T, Q> &b, const vec<3, T, Q> &c, const vec<3, T, Q> &d, const vec<3, T, Q> &e, size_t &redundantPoint, const T eps = epsilon<T>()) {
...
GLM_GEOM_QUALIFIER_OUTINLINE Sphere<3, T, Q> optimalEnclosingSphere(const Vector &pts, const T eps = epsilon<T>()) {
  switch (pts.size()) {
    case 0:
      return Sphere<3, T, Q>(T(0));
    case 1:
      return Sphere<3, T, Q>(pts[0], T(0));
    case 2:
      return optimalEnclosingSphere<T, Q>(pts[0], pts[1], eps);
    case 3:
      return optimalEnclosingSphere<T, Q>(pts[0], pts[1], pts[2], eps);
    case 4:
      return optimalEnclosingSphere<T, Q>(pts[0], pts[1], pts[2], pts[3], eps);
    default: {
      break;
    }
  }
