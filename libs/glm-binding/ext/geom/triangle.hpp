...
/// @TODO: Commented out until binding implementation is complete.
/// </summary>
// template<length_t L, typename T, qualifier Q>
...
/// </summary>
template<typename T, qualifier Q>
GLM_GEOM_QUALIFIER bool contains(const Triangle<3, T, Q> &t, const vec<3, T, Q> &point, const T thicknessSq = squared_eps<T>()) {
...
/// </summary>
template<typename T, qualifier Q>
GLM_GEOM_QUALIFIER bool contains(const Triangle<3, T, Q> &t, const LineSegment<3, T, Q> &segment, const T thicknessSq = squared_eps<T>()) {
...
/// </summary>
template<typename T, qualifier Q>
GLM_GEOM_QUALIFIER bool contains(const Triangle<3, T, Q> &t, const Triangle<3, T, Q> &other, const T thicknessSq = squared_eps<T>()) {
...
/// </summary>
template<length_t L, typename T, qualifier Q>
GLM_GEOM_QUALIFIER_OUTINLINE T intersectTriangleLine(const Triangle<L, T, Q> &t, const vec<L, T, Q> &linePos, const vec<L, T, Q> &lineDir, T &u, T &v) {
  ...
  if (abs(det) <= eps) {  // Determinant zero: line lies on plane of triangle
...
/// </summary>
template<length_t L, typename T, qualifier Q>
GLM_GEOM_QUALIFIER_OUTINLINE vec<L, T, Q> closestPointTriangle(const Triangle<L, T, Q> &t, const vec<L, T, Q> &p, T &u, T &v, T &w) {
...
/// </summary>
template<length_t L, typename T, qualifier Q, typename Line>
GLM_GEOM_QUALIFIER_OUTINLINE vec<L, T, Q> closestPointTriangleSegment(const Triangle<L, T, Q> &t, const LineSegment<L, T, Q> &line, T &outU, T &outV, T &outD) {
  outD = intersectTriangleLine(t, line.a, line.b - line.a, outU, outV);
...
/// </summary>
template<length_t L, typename T, qualifier Q>
GLM_GEOM_QUALIFIER_OUTINLINE vec<L, T, Q> closestPoint(const Triangle<L, T, Q> &t, const vec<L, T, Q> &p) {
  T u, v, w;
...
GLM_GEOM_QUALIFIER bool intersects(const Triangle<L, T, Q> &t, const LineSegment<L, T, Q> &line, T &u, T &v, T &d) {
  d = intersectTriangleLine(t, line.a, line.b - line.a, u, v);
...
GLM_GEOM_QUALIFIER bool intersects(const Triangle<L, T, Q> &t, const Sphere<L, T, Q> &sphere, vec<L, T, Q> &intersection) {
  ...
  return distance2(intersection, sphere.pos) <= sphere.r * sphere.r;  // @TODO: + epsilon<T>()
}

template<length_t L, typename T, qualifier Q>
GLM_GEOM_QUALIFIER bool intersects(const Triangle<L, T, Q> &t, const LineSegment<L, T, Q> &line) {
  T u, v;
  const T d = intersectTriangleLine(t, line.a, line.b - line.a, u, v);
  return d >= T(0.0) && d <= T(1.0);
}
