...
template<length_t L, typename T, qualifier Q>
GLM_GEOM_QUALIFIER_OUTINLINE vec<L, T, Q> closestPoint(const Ray<L, T, Q> &ray, const Line<L, T, Q> &other, T &d1, T &d2) {
...
template<length_t L, typename T, qualifier Q>
GLM_GEOM_QUALIFIER_OUTINLINE vec<L, T, Q> closestPoint(const Ray<L, T, Q> &ray, const Ray<L, T, Q> &other, T &d1, T &d2) {
  closestPointLineLine(ray.pos, ray.dir, other.pos, other.dir, d1, d2);
  if (d1 < T(0) && d2 < T(0)) {
...
template<length_t L, typename T, qualifier Q>
GLM_GEOM_QUALIFIER_OUTINLINE vec<L, T, Q> closestPoint(const Ray<L, T, Q> &ray, const LineSegment<L, T, Q> &other, T &d1, T &d2) {
...
template<length_t L, typename T, qualifier Q>
GLM_GEOM_QUALIFIER bool contains(const Ray<L, T, Q> &ray, const vec<L, T, Q> &point, T distanceThreshold = contains_eps<T>()) {
  T ignore(0);
  return distance2(closestPoint(ray, point, ignore), point) <= distanceThreshold;
}

template<length_t L, typename T, qualifier Q>
GLM_GEOM_QUALIFIER bool contains(const Ray<L, T, Q> &ray, const LineSegment<L, T, Q> &lineSegment, T distanceThreshold = contains_eps<T>()) {
